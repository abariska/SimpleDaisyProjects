...
int main(void)
{
    ...
    spi_conf.periph = SpiHandle::Config::Peripheral::SPI_1;      // Use the SPI_2 Peripheral
    ...
    spi_conf.pin_config.sclk = DaisySeed::D10; // Use pin D10 as SCLK
    spi_conf.pin_config.miso = Pin();             // We won't need this
    spi_conf.pin_config.mosi = DaisyPatchSM::D9;  // Use D9 as MOSI
    spi_conf.pin_config.nss = DaisyPatchSM::D7;             // DaisyPatchSM::D1;   // use D1 as NSS
